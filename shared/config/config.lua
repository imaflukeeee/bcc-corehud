...
Config.EnableMailboxCore        = true         -- แสดง Core ข้อความเมื่อเป็น true
...
Config.BleedCore                = {
    ...
    UseBccMedical         = false   -- เมื่อเป็น true HUD จะดึงข้อมูลเลือดไหลจาก bcc-medical; ตั้งค่าเป็น false เมื่อใช้งานร่วมกับระบบอื่น
}
